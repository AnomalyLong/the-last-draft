...
// Memoized: HUD and overlays re-render every game frame — unchanged labels skip
// rebuilding their (5× per pixel with outline) rect arrays entirely.
export const PixelText = React.memo(function PixelText({ text, x, y, scale = 2, fill = '#fff', outline = '#000', thick = false }) {
...
export const PixelTextC = React.memo(function PixelTextC({ text, cx, y, scale = 2, ...rest }) {
