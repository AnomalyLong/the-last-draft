...
export const Court = React.memo(function Court({ netSwish = { left: 0, right: 0 }, netDunk = { left: 0, right: 0 }, netMiss = { left: 0, right: 0 } }) {
  return (
    <g>
      ...
      {/* Net shadows — nudged 5px toward court center on each side (4px + 3px - 2px) to sit directly under the rim. */}
      <ellipse cx={47} cy={COURT_MID_Y} rx={7} ry={3} fill="none" stroke="#8a6a3a" strokeWidth={1.5} opacity={0.5} />
      <ellipse cx={633} cy={COURT_MID_Y} rx={7} ry={3} fill="none" stroke="#8a6a3a" strokeWidth={1.5} opacity={0.5} />
