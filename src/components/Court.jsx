...
import bg7 from '../sprites/BG7.svg';

export function Court() {
  return (
    <g>
      <image href={bg7} x={-154} y={0} width={494} height={428} />
      <g transform="translate(340, 0) scale(-1, 1) translate(-494, 0)">
        <image href={bg7} x={0} y={0} width={494} height={428} />
      </g>
